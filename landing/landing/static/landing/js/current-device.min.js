...
!function(n, e) {
    ...
    , function(n, e, o) {
        ...
        function f(n) {
            var e = null;
            s(n) || (e = c.className.replace(/^\s+|\s+$/g, ""),
            c.className = e + " " + n)
        }
        function b(n) {
        ...
        function p() {
            i.landscape() ? (b("portrait"),
            f("landscape"),
            w("landscape")) : (b("landscape"),
            f("portrait"),
            w("portrait")),
            v()
        }
        ...
        window.addEventListener ? window.addEventListener(y, p, !1) : window.attachEvent ? window.attachEvent(y, p) : window[y] = p,
        p(),
